<template>
    <div>
        <el-breadcrumb separator="/" class="breadcrumb">
            ...
            <el-breadcrumb-item>歌曲图片更换</el-breadcrumb-item>
        </el-breadcrumb>
        <el-row>
            <el-col :span="12">
                <div>
                    <h3 style="text-align: center">原歌曲图片：</h3>
            ...
            <el-col :span="12">
                <div>
                    <h3 style="text-align: center">新歌曲图片：</h3>
...
export default {
    ...
    data() {
        return {
            ...
            submit_url: APIURL + '/song/modify/icon',
            old_img: PLACEHOLDERIMG,
            new_img: ''
        };
    },
    created() {
        this.getSongIcon(this.$route.params.id);
    },
    methods: {
        getSongIcon(id) {
            let getData = {
            ...
            this.axios.get(this.icon_url, {
                ...
                .then((response) => {
                    if (response.data.status === 0) {
                        this.old_img = response.data.data.song_icon;
                    }
                })
