<template>
    <div>
        <el-breadcrumb separator="/" class="breadcrumb">
            ...
            <el-breadcrumb-item>歌手图片更换</el-breadcrumb-item>
        </el-breadcrumb>
        <el-row>
            <el-col :span="12">
                <div>
                    <h3 style="text-align: center">原歌手图片：</h3>
            ...
            <el-col :span="12">
                <div>
                    <h3 style="text-align: center">新歌手图片：</h3>
...
export default {
    ...
    data() {
        return {
            icon_url: APIURL + '/singer/show',
            submit_url: APIURL + '/singer/modify/icon',
            old_img: PLACEHOLDERIMG,
            new_img: ''
        };
    },
    created() {
        this.getSingerIcon(this.$route.params.id);
    },
    methods: {
        getSingerIcon(id) {
            let getData = {
            ...
            this.axios.get(this.icon_url, {
                ...
                .then((response) => {
                    if (response.data.status === 0) {
                        this.old_img = response.data.data.singer_icon;
                    }
                })
